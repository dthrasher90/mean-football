...
//
              ...
              // console.log("playcount = ", playCount);
                  ...
                  // var DT1x = ct.x + 40;
                  // var DT1y = ct.y  -20;
                  // var dt3= game.add.sprite(DT1x, DT1y, 'dt1');
                  //         dt3.scale.setTo(0.061);
                  // var spriteTextDT1 = game.add.text(DT1x, DT1y, 'DT1', {font: '9px Press Start 2P'});
                  // this.game.physics.arcade.enable(dt3, Phaser.Physics.ARCADE);
                  // console.log('dt1', dt3);
                  // dt3.body.velocity.x = -50;
                  // //
                  //
                  // var DT2x = ct.x + 40;
                  // var DT2y = ct.y - 10;
                  ...
                  // this.game.physics.arcade.enable(dt2, Phaser.Physics.ARCADE);
                  // console.log('dt2 ===   ', dt2);
                  // dt2.body.velocity.x = -50;
//
//
